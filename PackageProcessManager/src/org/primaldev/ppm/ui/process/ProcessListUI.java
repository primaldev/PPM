...
public class ProcessListUI extends CustomComponent {
	...
	private void initTable(){
		...
		dataSource = new BeanItemContainer<ProcessDefinition>(ProcessDefinition.class,getAllTaskProcessDefinitions());
		...
		setProcessDefinitions(getAllTaskProcessDefinitions());
	...
	private List<ProcessDefinition> getAllTaskProcessDefinitions() {
		ProcessDefinitionQuery query = getRepositoryService()
				.createProcessDefinitionQuery();
		return query.startableByUser(ProcessUtil.getIdOfCurrentUser()).processDefinitionCategoryNotEquals(ReportUtil.PROCESS_CATOGORY_NAME).orderByProcessDefinitionName().asc().list();
