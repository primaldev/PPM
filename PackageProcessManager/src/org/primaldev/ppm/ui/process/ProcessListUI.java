...
public class ProcessListUI extends CustomComponent {
	...
	public void openFormForProcessDefinition(ProcessDefinition processDef) {
		...
		if (formKey != null) {
			...
			//fire backboard to show form
	    	
			
		//	params.put(UserFormViewUI.KEY_FORM_KEY, formKey);
		//	params.put(UserFormView.KEY_PROCESS_DEFINITION_ID, processDef.getId());
		//	goToView(UserFormView.VIEW_ID, params);
		}
	}
