...
public class ExploreTasks extends CustomComponent {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		productTaskTable_1.setWidth("900px");
		productTaskTable_1.setHeight("100.0%");
		mainLayout.addComponent(productTaskTable_1,
				"top:100.0px;bottom:40.0px;left:2.0px;");
		...
		mainLayout.addComponent(filterAssignBox, "top:40.0px;left:422.0px;");
