...
public class GroupManagementTab extends CustomComponent {
	...
	private void initTable(){
		...
		groupListTable.setSizeFull();
		groupListTable.setSelectable(true);
		groupListTable.setImmediate(true);
		groupListTable.addValueChangeListener(new ValueChangeListener() {
