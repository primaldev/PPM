...
import org.primaldev.ppm.ui.task.UnassignedTasksUI;
...
public class MainUI extends CustomComponent implements View, SwitchView_Listener, RefreshLabels_Listener  {
	...
	UnassignedTasksUI unassignedTasksUI;
	...
	private void initUserFormViewUI(ProcessDefinition processDefinition){
		...
		userFormViewUI.setHeight("100.0%");		
			...
			mainTabSheet.addTab(userFormViewUI, "Start Process", null);
	...
	private void initunAssignedTasksUI(){
		...
		unassignedTasksUI = new UnassignedTasksUI();
	...
	public void onSwitchView(SwitchView_Event event) {
		...
		if(viewName.equals(UserFormViewUI.NAME)){			
			initUserFormViewUI(event.getProcessDefinition());
		}
